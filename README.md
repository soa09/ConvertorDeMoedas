...
Inserção de Valor: O usuário pode inserir o valor que deseja converter. 💵

Taxa de Câmbio Fixa: O programa usa uma taxa de câmbio fixa, definida diretamente no código. 📊💲

Interatividade: Você pode realizar várias conversões na mesma execução, com a opção de continuar após cada operação. 🔄
